...
<div class="row justify-content-center">
    <div class="col-12 col-md-5 card shadow mt-3 mb-4">
        <div class="card-body">
    ...
    <div class="col-12 col-md-5 md-4 card shadow ml-3 mt-3 mb-4">
        <div class="card-body">
...
<div class="row justify-content-center">
            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="kasir" width="100%" cellspacing="0">
                    ...
                    <tbody class="produk-item" data-target="thead" data-spy="scroll" data-offset="0">
                        ...
                        <tr>
                            <td>{{ $index+1}}</td>
                            <td>{{ \DB::table('products')->where('id', $item->product_id)->value('product_name')}}</td>
                            <td>{{ $item->qty}}</td>
                            @php
                            $hrg = \DB::table('products')->where('id', $item->product_id)->value('price');
                            $qty = $item->qty;
                            $sub = $hrg * $qty;
                            $total += $sub;
                            @endphp
    ...
    <div class="col-12 col-md-5 md-4 card mt-3 ml-3 shadow mb-4">
        <div class="card-body">
